const englandVsIndia = {
  englandPlayers: {
    "Jason Roy": { name: "Jason Roy", runs: 27, wickets: 0, position: 1, posQ: 0, adjustedRuns: 0, adjustedWickets: 0 },
    "Jos Buttler": { name: "Jos Buttler", runs: 18, wickets: 0, position: 2 , posQ: 0, adjustedRuns: 0, adjustedWickets: 0 },
    "Dawid Malan": { name: "Dawid Malan", runs: 77, wickets: 0, position: 3, posQ: 0, adjustedRuns: 0, adjustedWickets: 0  },
    "Philip Salt": { name: "Philip Salt", runs: 8, wickets: 0, position: 4, posQ: 0, adjustedRuns: 0, adjustedWickets: 0  },
    "Liam Livingstone": { name: "Liam Livingstone", runs: 42, wickets: 0, position: 5 , posQ: 0, adjustedRuns: 0, adjustedWickets: 0 },
    "Moeen Ali": { name: "Moeen Ali", runs: 0, wickets: 1, position: 6 , posQ: 0, adjustedRuns: 0, adjustedWickets: 0 },
    "Harry Brook": { name: "Harry Brook", runs: 19, wickets: 0, position: 7 , posQ: 0, adjustedRuns: 0, adjustedWickets: 0 },
    "Chris Jordan": { name: "Chris Jordan", runs: 11, wickets: 2, position: 8 , posQ: 0, adjustedRuns: 0, adjustedWickets: 0 },
    "David Willey": { name: "David Willey", runs: 0, wickets: 2, position: 9 , posQ: 0, adjustedRuns: 0, adjustedWickets: 0 },
    "Reece Topley": { name: "Reece Topley", runs: 0, wickets: 3, position: 10 , posQ: 0, adjustedRuns: 0, adjustedWickets: 0 },
    "Richard Gleeson": { name: "Richard Gleeson", runs: 0, wickets: 1, position: 11 , posQ: 0, adjustedRuns: 0, adjustedWickets: 0 },
    "Sam Curran": { name: "Sam Curran", runs: 0, wickets: 0, position: 12 , posQ: 0, adjustedRuns: 0, adjustedWickets: 0 },
    "Tymal Mills": { name: "Tymal Mills", runs: 0, wickets: 0, position: 13, posQ: 0, adjustedRuns: 0, adjustedWickets: 0  },
    "Matt Parkinson": { name: "Matt Parkinson", runs: 0, wickets: 0, position: 14 , posQ: 0, adjustedRuns: 0, adjustedWickets: 0 },
  },
  indiaPlayers: {
...
function startUp(document) {
  ...
  populateTable(document.getElementById("playerTable2").getElementsByTagName("tr"), englandVsIndia.indiaPlayers, "runs");
